...
- Preserve the user's original story and all historical dates. With the user's approval, the September 15, 2026 editorial pass shortened older entries without changing their dates or underlying events. The user prefers all update dates and titles visible in one list, with only the newest entry expanded by default.
